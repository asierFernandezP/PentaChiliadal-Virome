...
for (sample in sample_names) {
    ...
    # Subset the table to only include rows corresponding to the genomes in genome_names
    ...
    results_table[idx, sample] <- cov_table[idx, 3] / cov_table[idx, 5] / reads_table[sample, 'clean_reads'] * 10^6
}
